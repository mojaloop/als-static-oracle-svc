# als-static-oracle-svc/src/server/handlers
...
Most files will depend on the specific to _als-static-oracle-svc_ data model which is implemented in [/src/model](../../model/README.md) module.
